...
public class SqlConfig
{
    ...
    public static SqlConfig UpdateWhere = new SqlConfig() { RequiredValue = true, SqlType = SqlPartial.Where };
    public static SqlConfig DeleteWhere = new SqlConfig() { RequiredValue = true, SqlType = SqlPartial.Where };
