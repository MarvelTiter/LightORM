...
internal class InternalDataReaderLight(DbDataReader dataReader, PrepareResult prepareResult, DatabaseConnection connection) : DbDataReader
{
    public override void Close()
    {
        ...
        prepareResult.Command.Parameters.Clear();
        prepareResult.Command.Dispose();
    }
    ...
    public override async Task CloseAsync()
    {
        ...
        prepareResult.Command.Parameters.Clear();
        await prepareResult.Command.DisposeAsync();
    }
#endif
